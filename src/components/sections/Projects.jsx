            ...
            <RevealOnScroll>
                <div className="max-w-5xl mx-auto px-4 pt-4 relative z-10">
                    ...
                    <div className="p-6">
                        ...
                        <a href="#" className="flex items-center justify-center gap-2 w-55 py-2 border border-[#800202] text-[#800202] rounded-md hover:bg-[#800202] hover:text-white transition">
                            👁️ Live Demo
                        </a>
                        <a href="#" className="flex items-center justify-center gap-2 w-55 py-2 border border-amber-500 text-amber-500 rounded-md hover:bg-amber-500 hover:text-white transition">
                            📁 GitHub
                        </a>
                        </div>
                    </div>
                    ...
                    <div className="p-6">
                        ...
                        <div className="flex justify-center gap-4">
                        <a href="#" className="flex items-center justify-center gap-2 w-55 py-2 border border-[#020618] text-[#020618] rounded-md hover:bg-[#020618] hover:text-white transition">
                            👁️ Live Demo
                        </a>
                        <a href="#" className="flex items-center justify-center gap-2 w-55 py-2 border border-indigo-400 text-indigo-400 rounded-md hover:bg-indigo-400 hover:text-white transition">
                            📁 GitHub
                        </a>
                        </div>
                    </div>
                    ...
                    <div className="p-6">
                        ...
                        <div className="flex justify-center gap-4">
                        <a href="#" className="flex items-center justify-center gap-2 w-55 py-2 border border-[#248b65] text-[#248b65] rounded-md hover:bg-[#248b65] hover:text-white transition">
                            👁️ Live Demo
                        </a>
                        <a href="#" className="flex items-center justify-center gap-2 w-55 py-2 border border-[#89dcd5] text-[#89dcd5] rounded-md hover:bg-[#89dcd5] hover:text-black transition">
                            📁 GitHub
                        </a>
                        </div>
                    </div>
                    ...
                    <div className="p-6">
                        ...
                        <div className="flex justify-center gap-4">
                        <a href="#" className="flex items-center justify-center gap-2 w-55 py-2 border border-[#68b658] text-[#68b658] rounded-md hover:bg-[#68b658] hover:text-white transition">
                            👁️ Live Demo
                        </a>
                        <a href="#" className="flex items-center justify-center gap-2 w-55 py-2 border border-lime-300 text-lime-500 rounded-md hover:bg-lime-300 hover:text-black transition">
                            📁 GitHub
                        </a>
                        </div>
                    </div>
