...
export const Contact = () => {
  ...
  return (
    <section id="contact" className="relative min-h-screen flex items-center justify-center py-16 sm:py-32 bg-white px-3 sm:px-4 overflow-hidden">
      <Particles
      ...
      <RevealOnScroll>
        <div className="w-full max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-8 sm:mb-16">
            <h1 className="text-3xl sm:text-5xl md:text-7xl font-black mb-4 text-black tracking-tight">
              {contact.title}{" "}
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-start">
            ...
            {/* Send Message Card - ALWAYS VISIBLE */}
            <CardWrapper gradient="bg-gradient-to-r from-purple-600 via-indigo-600 to-purple-600">
              <div className="p-5 sm:p-8 md:p-10">
                <div className="flex items-center gap-3 mb-6 sm:mb-8">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-gradient-to-br from-purple-600 to-indigo-600 flex items-center justify-center shadow-lg">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 sm:h-6 sm:w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                  </div>
                  <div>
                    <h3 className="text-xl sm:text-2xl font-bold text-black">Send Message</h3>
                    <p className="text-gray-600 text-xs sm:text-sm">We'll get back to you soon</p>
                  </div>
                </div>
                <form className="space-y-4 sm:space-y-6" onSubmit={handleSubmit}>
                  ...
                  >
                    <div className="relative flex items-center justify-center gap-3 rounded-xl bg-white px-6 sm:px-8 py-3 sm:py-4 text-purple-600 group-hover/btn:bg-transparent group-hover/btn:text-white">
